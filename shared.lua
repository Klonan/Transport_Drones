...
data.drone_collision_mask = {"layer-15", "layer-14", "resource-layer", "ground-tile", "water-tile", "not-colliding-with-itself", "colliding-with-tiles-only", "consider-tile-transitions"}
